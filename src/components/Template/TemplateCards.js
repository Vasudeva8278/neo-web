  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center pt-8 px-4 relative z-10">
        <div
          className="w-full h-48 bg-white rounded-xl shadow-sm flex items-center justify-center overflow-hidden p-2" // Reduced padding around image
      ...
      <div className="bg-white rounded-b-2xl px-6 pt-4 pb-6 flex flex-col items-start w-full min-h-[100px]"> {/* Increased pt for more space above text */}
        ...
        <div className="flex w-full justify-between gap-4 mt-2">
          <button
            className="flex-1 flex flex-col items-center justify-center py-2 rounded-xl hover:bg-gray-100 transition text-blue-700 font-semibold text-base" // Adjusted font size
            onClick={handleEdit}
          >
            <FaEdit className="text-lg mb-1" /> {/* Adjusted icon size */}
            Edit
          </button>
          <button
            className="flex-1 flex flex-col items-center justify-center py-2 rounded-xl hover:bg-gray-100 transition text-blue-700 font-semibold text-base" // Adjusted font size
          ...
          >
            <FaFileAlt className="text-lg mb-1" /> {/* Adjusted icon size */}
            Create
          </button>
        </div>
      </div>
